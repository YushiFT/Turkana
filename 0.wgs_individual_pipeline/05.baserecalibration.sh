#!/bin/bash
#SBATCH --job-name=192rebase     # create a short name for your job
...
#java -Xmx60g -jar $in_picard AddOrReplaceReadGroups I=$out_bam_duplicates O=$out_bam_readgroups SO=coordinate RGLB=$barcode RGPL=illumina RGPU=turkana RGSM=$barcode
