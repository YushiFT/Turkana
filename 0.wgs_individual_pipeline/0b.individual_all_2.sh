#!/bin/bash
#SBATCH --job-name=368rebase     # create a short name for your job
...
out_bam_sorted=/Genomics/grid/users/yushit/temp/$barcode.hg38.sorted.bam
out_bam_duplicates=/Genomics/grid/users/yushit/temp/$barcode.hg38.dup.bam
out_txt_dupmetrics=/Genomics/grid/users/yushit/temp/$barcode.hg38.dup.txt
out_bam_readgroups=/Genomics/grid/users/yushit/temp/$barcode.hg38.reg.bam
out_table_recalibr=/Genomics/grid/users/yushit/temp/$barcode.rbqs.table
out_bam_recalibrat=/Genomics/grid/users/yushit/temp/$barcode.rbqs.bam
out_g_vcf=/Genomics/ayroleslab2/yushi/data/turkana_wgs_vcf/$barcode.hg38.g.vcf
...
$in_sambamba index -t 8 $out_bam_readgroups
...
$in_sambamba index -t 8 $out_bam_recalibrat
